...
CREATE TABLE `person_profile` (
	...
	`ip_group_id` integer,
	`solo_parent` integer,
	`children_and_youth_in_need_of_special_protection` integer,
	`out_of_school_youth` integer,
	`family_heads_in_need_of_assistance` integer,
	`affected_by_disaster` integer,
	`persons_with_disability` integer,
	`senior_citizen` integer,
	`is_family_beneficiary_of_cfw` integer DEFAULT false,
	`school_name` text,
	`campus` text,
	`school_address` text,
	`course_id` integer,
