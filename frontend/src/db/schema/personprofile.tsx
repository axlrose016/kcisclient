...
export const person_profile = sqliteTable("person_profile", {
    ...
    email: text("email"),
    has_immediate_health_concern: integer("has_immediate_health_concern", { mode: "boolean" }).default(false),
    ...
    representative_extension_name_id: text("representative_extension_name_id"),
    ...
    representative_has_health_concern: text("representative_has_health_concern"),
    ...
    occupation_id_card_id: integer("id_card"),
