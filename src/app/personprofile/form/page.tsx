    ...
    <Card>
      ...
      <CardContent>
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          ...
          <div className="p-3 col-span-full flex justify-center">
          ...
          <div className={`p-3  ${commonData.modality_id !== undefined && commonData.modality_id === 25 ? "" : "hidden"}`}>
          ...
          <div className="p-3"><Label htmlFor="last_name" className="block text-sm font-medium">Last Name<span className='text-red-500'> *</span></Label>
            <Input
          ...
          <div className="p-3"><Label htmlFor="philsys_id_no" className="block text-sm font-medium">PhilSys ID Number</Label>
            <Input
          ...
          <div className="p-3">
            <Label htmlFor="birthplace" className="block text-sm font-medium">Birthplace <span className='text-red-500'> *</span></Label>
            <Textarea
