...
export default function SectorDetails({ errors, capturedData, sectorData, disabilitiesData, selectedModality, updateFormData, updateSectorData, updateDisabilityData, session, user_id_viewing }: {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                if (storedSectors) {
                    setListOfSelectedSectors(JSON.parse(storedSectors));
    ...
    const handleSectorRadioGroupChange = (e: any) => {
        ...
        const isPWDSector = e.find((sector: any) => sector.sector_id.toString() === "3" && sector.is_deleted == false);
        ...
        const isIPSector = e.find((sector: any) => sector.sector_id.toString() === "4" && sector.is_deleted == false);
        ...
        <div className="pt-4">
            ...
            <Alert className="mb-3" variant={"information"}>
                ...
                <AlertDescription>
                    ...
                    <br />Select "Yes" or "No" for each sector.
                    <br />If you select "Persons with Disability", you will be asked to specify the type(s) of disability.
                    <br />If you select "Indigenous People", you will be asked to specify the IP group.
                </AlertDescription>
            </Alert>


            <div className=" grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 gap-y-5 gap-x-5 mb-2" id="sectors_info_form">
                ...
                <div
                    className={`p-2 border rounded-lg p-5 ${isListOfDisabsEnabled ? "" : "hidden"} `}

                >
                    <Label htmlFor="type_of_disabilities" className="block text-sm font-medium mb-3">
                        Type of Disability
                    </Label>
                    <FormMultiDropDown
                ...
                <div className={`p-2 border rounded-lg p-5 ${showListOfIPs ? "" : "hidden"}`}>
