...
class LibDatabase extends Dexie {
    ...
    lib_payroll_rate!: Table<ILibPayrollRate, string>;
    ...
    constructor() {
        ...
        this.version(1).stores({
            ...
            lib_payroll_rate: `reg_id, code_correspondence, name, altName, code, geo_level, rate, ${commonFields}`,
        })
